...
const baritone = require('@miner-org/mineflayer-baritone'); // <--- CAMBIO AQUÍ
...
bot.on('spawn', () => {
    ...
    bot.chat("He llegado. Enséñame sobre este mundo y lo recordaré.");
});
